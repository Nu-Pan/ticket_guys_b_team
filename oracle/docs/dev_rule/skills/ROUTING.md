# `apply_oracle_to_implements.md`

- `oracle` の変更・指定範囲を実装に反映させるスキルの目的、調査範囲、自己レビュー、作業レポート要件を記述
...
- `oracle` の問題点を評価するスキルについて、前提、評価観点、評価しない観点を記述

# `general_rule.md`

- リポジトリローカルなスキルについての基本原則・規則を記述
