...
- `AGENTS.md` を読んだうえで、`oracle/ROUTING.md` から必要な階層の `ROUTING.md` を辿る。
...
3. `oracle/ROUTING.md` から `oracle/docs/ROUTING.md`、`oracle/docs/dev_rule/ROUTING.md` を辿り、必要な `oracle/docs/dev_rule/*` の制約を確認する
