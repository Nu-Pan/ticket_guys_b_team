...
def _run_editor(instruction_file: Path) -> None:
    """
    利用可能なエディタを起動する。
    """
    ...
    if editor:
        ...
        _run_required_command(command, instruction_file)
        return
...
def _run_required_command(command: list[str], instruction_file: Path) -> None:
    """
