...
* `.tgbt/plans/<plan_id>.md` を生成または更新する
* 実行結果として少なくとも `Plan: <plan_id>`、`Plan revision: <plan_revision>`、`Updated: .tgbt/plans/<plan_id>.md` を表示する
* 主要な session record 参照先を `Session record: <repo-relative path>` として表示する

例:

```text
Plan: plan-20260321-001
Updated: .tgbt/plans/plan-20260321-001.md
Plan revision: 2
Status: draft
...
Plan revision: 2
Status: settled
Log: .tgbt/logs/plan-20260321-001-run-0003.jsonl
Updated tickets:
- .tgbt/tickets/worker-0007.md
- .tgbt/tickets/worker-0008.md
```
